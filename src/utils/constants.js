...
export const API_ENDPOINTS = {
  ...
  SOUL_WINNING_RECORDS_BULK_DELETE: `${API_V1}/soul-winning/records/bulk-delete`,
  ...
  FILE_STORAGE_THUMBNAIL: (id) => `${API_V1}/file-storage/${id}/thumbnail`,
...
export const APP_API_ENDPOINTS = {
  ...
  SOUL_WINNING_RECORDS_BULK_DELETE: "/api/soul-winning/records/bulk-delete",
  ...
  FILE_STORAGE_THUMBNAIL: (id) => `/api/file-storage/${id}/thumbnail`,
